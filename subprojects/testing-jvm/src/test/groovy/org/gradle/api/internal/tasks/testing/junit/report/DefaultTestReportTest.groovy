...
class DefaultTestReportTest extends Specification {
    ...
    def reportWithMaxThreads(int numThreads) {
        buildOperationProcessor = new DefaultBuildOperationProcessor(Stub(WorkerLeaseRegistry), new TestBuildOperationExecutor(), new DefaultBuildOperationQueueFactory(), new DefaultExecutorFactory())
