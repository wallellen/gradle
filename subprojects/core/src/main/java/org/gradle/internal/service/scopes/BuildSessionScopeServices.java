...
public class BuildSessionScopeServices extends DefaultServiceRegistry {
    ...
    BuildOperationProcessor createBuildOperationProcessor(WorkerLeaseRegistry workerLeaseRegistry, BuildOperationExecutor buildOperationExecutor, ExecutorFactory executorFactory) {
        return new DefaultBuildOperationProcessor(workerLeaseRegistry, buildOperationExecutor, new DefaultBuildOperationQueueFactory(), executorFactory);
    }
