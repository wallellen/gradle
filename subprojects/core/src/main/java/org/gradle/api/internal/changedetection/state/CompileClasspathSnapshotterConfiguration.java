...
public class CompileClasspathSnapshotterConfiguration extends SnapshotterConfiguration {
    ...
    public CompileClasspathSnapshotterConfiguration(FileHasher hasher) {
        this.hasher = hasher;
    }
