...
abstract class NativeCompilerTest extends Specification {
    ...
    protected BuildOperationProcessor buildOperationProcessor = new DefaultBuildOperationProcessor(Stub(WorkerLeaseRegistry), new TestBuildOperationExecutor(), new DefaultBuildOperationQueueFactory(), new DefaultExecutorFactory())
